...
char* find_identifier_c(char* line, size_t pos) {
    char* identifier = (char*)malloc(strlen(line) + 1);
    size_t assign_pos = (size_t)strstr(line, "=");
    if (assign_pos != (size_t)NULL) {
    ...
    size_t space_pos = (size_t)strstr(line, " ");
    if (space_pos != (size_t)NULL && space_pos < pos) {
    ...
    size_t assign_pos2 = (size_t)strrchr(identifier, '=');
    if (assign_pos2 != (size_t)NULL) {
